...
#for user in nonprod_bm_app_user nonprod_bm_cli_access nonprod_bm_eks_control nonprod_bm_gitlab_ci 
for user in nonprod_bm_eks_control
do
   USER_NAME=$user
