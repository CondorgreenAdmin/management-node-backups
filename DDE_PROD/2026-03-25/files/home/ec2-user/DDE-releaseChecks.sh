...
#DL="arnulf.hanauer@vcontractor.co.za, michaelalex.dirks@vcontractor.co.za, arnulf.hanauer@condorgreen.com"


DTE1=$(date +"%d-%B-%Y")
DTE2=$(date +"%Y-%m-%d")

attachment=$(echo "DDE_PROD_release_checks_"$DTE2".html")
out1=$$_temp_html
...
cr_heading "DDE Application Source Code Versioning"
...
###Publish report
mutt -e "set content_type=text/html" -s "DDE PRODUCTION Release Checks" -a ${attachment} -- $DL < $attachment
...
#rm heading.txt sent $attachment $out1
#echo
#ls -lt | head -10
