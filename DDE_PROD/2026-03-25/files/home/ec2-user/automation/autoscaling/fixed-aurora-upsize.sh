...
DDE scheduled autoscaling (up-scaling) was triggered. Full log attached.
...
EOF
  ...
  mutt -s "DDE Scheduled Autoscaling (up-scaling) invoked" "arnulf.hanauer@vcontractor.co.za,arnulf.hanauer@condorgreen.com" -a tac_$$ < outMSG_$$
  sleep 5
  rm outMSG_$$ tac_$$
