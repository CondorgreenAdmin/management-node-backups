...
do
	...
	echo $PATH > MYFILE
	echo 'mysql --defaults-extra-file=~/versioning/sp_deployments/dde-sox-new.cnf --comments < $file'
#	mysql --defaults-extra-file=/home/ec2-user/versioning/sp_deployments/dde-sox-new.cnf -e "select 1"
	error=$?
...
then
	...
	echo 'aws s3 mv s3://prd-dde-share/sp_deployments/ s3://prd-dde-share/sp_deployments_archive/$version/ --recursive'
	echo "Cleaned up S3"
