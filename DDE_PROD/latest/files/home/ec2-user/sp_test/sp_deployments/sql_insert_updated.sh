...
do
	...
	echo "mysql --defaults-extra-file=dde-sox-new.cnf --comments < $file"
	error=0
	#error=$?
...
then
	...
	echo "mysql --defaults-extra-file=dde-sox-new.cnf --comments < rollback.sql"
