...
EOF
   ...
   mutt -s "DDE PRD Linux Local Users expired passwords" $DL < $$outBODY
   rm $$outBODY $$outMSG
fi
...
#mutt -s "DDE Linux Local Users" -a $outputLOCAL -- arnulf.hanauer@vcontractor.co.za < MailHeaderDDELinux.txt
